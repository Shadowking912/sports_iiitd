  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            customAppBar("EVENTS", false, context, logo: true),
            CustomSearchBar(),
            MonthlyEvents(),
          ],
        ),
...
class _MonthlyEventsState extends State<MonthlyEvents> {
  final Map<String, List<Event>> eventsByMonth = {
    ...
    "November": [
      Event(name: "Football Intra", month: "November", day: "Friday", date:"08", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod.", img:"event1.jpg"),
      Event(name: "Squash Intra",month:"November", day: "Monday", date:"11", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod.", img:"event2.jpg"),
      Event(name: "Badminton Intra",month:"November",day: "Tuesday", date: "12", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod.", img:"event3.jpg"),
      Event(name: "Tennis Intra",month:"November",day: "Tuesday", date: "12", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod.", img:"event4.jpg"),
      ],
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: EdgeInsets.fromLTRB(0,30,20,0), // Adjust the padding as needed
          child: Row(
